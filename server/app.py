...
This module creates an HTTP server that exposes the MaskguardDataPrivacyOpenenvEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m maskguard_data_privacy_openenv.server.app
    ...
    multiple workers:
        uvicorn maskguard_data_privacy_openenv.server.app:app --workers 4
    """
    import uvicorn
